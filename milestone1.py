...
def add_data_for_name ( name_data, year, rank, name ):
    ...
    if name in name_data:  # First, check whether name in the dictionary
        """
        ...
        if year not in name_data [ name ] or year in name_data [ name ] and int (name_data [ name ] [ year ]) > int (
                rank):
